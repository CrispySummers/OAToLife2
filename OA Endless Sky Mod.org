...
**** TODO research what factions there are in Orion's Arm [1/1]
...
**** TODO research is Endless Sky the best option to scaffold upon? [0/1]
***** TODO look online for and take notes on is Endless Sky the best option to scaffold upon? :@computer:@internet:
:PROPERTIES:
:EFFORT:   10min
:END:
**** TODO research how to make mods in general [0/1]
***** TODO look online for and take notes on how to make mods in general :@computer:@internet:
:PROPERTIES:
:EFFORT:   10min
:END:
**** TODO research how to make Endless Sky mods [1/1]
...
:ORDERED:  t
:END:
**** TODO use ChatGPT to convert descriptions on the EG of 30 important star systems (the capital systems of Major Empires) to files for this mod :@computer:@internet:
:PROPERTIES:
:EFFORT:   5min
:END:
**** TODO prototype star systems (3) [0/3]
***** TODO prototype Solsys [0/2]
:PROPERTIES:
:ORDERED:  t
:END:
****** TODO feed Solsys's description into ChatGPT and generate an Endless Sky data file :@@internet:
:PROPERTIES:
:EFFORT:   5min
:END:
****** TODO change the sprites and orbital distances of prototype Solsys until it looks accurate in position and planets :@computer:think:
:PROPERTIES:
:EFFORT:   5min
:END:
***** TODO prototype Resonance [/]
:PROPERTIES:
:ORDERED:  t
:END:
****** TODO feed Resonance's description into ChatGPT and generate an Endless Sky data file :@@internet:
:PROPERTIES:
:EFFORT:   5min
:END:
****** TODO change the sprites and orbital distances of prototype Resonance until it looks accurate in position and planets :@computer:think:
:PROPERTIES:
:EFFORT:   5min
:END:
***** TODO prototype Ain Soph Aur [/]
:PROPERTIES:
:ORDERED:  t
:END:
****** TODO feed Ain Soph Aur's description into ChatGPT and generate an Endless Sky data file :@@internet:
:PROPERTIES:
:EFFORT:   5min
:END:
****** TODO change the sprites and orbital distances of prototype Ain Soph Aur until it looks accurate in position and planets :@computer:think:
:PROPERTIES:
:EFFORT:   5min
:END:
***** TODO prototype Heartland [/]
:PROPERTIES:
:ORDERED:  t
:END:
****** TODO feed Heartland's description into ChatGPT and generate an Endless Sky data file :@@internet:
:PROPERTIES:
:EFFORT:   5min
:END:
****** TODO change the sprites and orbital distances of prototype Heartland until it looks accurate in position and planets :@computer:think:
:PROPERTIES:
:EFFORT:   5min
:END:
**** TODO prototype planets [0/4]
***** TODO prototype Solsys Planets [0/1]
****** TODO change the textures of the Solsys Planets to something good :@computer:think:
:PROPERTIES:
:EFFORT:   3min
:END:
***** TODO prototype Resonance Planets [/]
****** TODO change the textures of the Resonance Planets to something good :@computer:think:
:PROPERTIES:
:EFFORT:   3min
:END:
***** TODO prototype Ain Soph Aur [/]
****** TODO change the textures of the Ain Soph Aur Planets to something good :@computer:think:
:PROPERTIES:
:EFFORT:   3min
:END:
***** TODO prototype Heartland [/]
****** TODO change the textures of the Heartland Planets to something good :@computer:think:
:PROPERTIES:
:EFFORT:   3min
:END:
**** Archai Nodes
...
:ORDERED:  t
:END:
******* TODO create more templates for the star systems of the {Empire Name} mentioned in the EG
:PROPERTIES:
:EFFORT:   5min
:END:
******* TODO add the planets for the star systems of the {Empire Name} with distances and textures
:PROPERTIES:
:EFFORT:   5min
:END:
**** TODO Minor Factions [/]
***** TODO Stella Umma [/]
****** TODO Umma Capital [0/2]
:PROPERTIES:
:ORDERED:  t
:END:
******* TODO create templates for Umma Capital
:PROPERTIES:
:EFFORT:   5min
:END:
******* TODO add the planets for Umma Capital
:PROPERTIES:
:EFFORT:   5min
:END:
****** TODO flesh out the star systems mentioned in the EG [0/2]
...
:EFFORT:   5min
:END:
***** TODO Perseus Princes [/]
****** TODO Serpiens [0/2]
:PROPERTIES:
:ORDERED:  t
:END:
******* TODO create templates for Serpiens
:PROPERTIES:
:EFFORT:   5min
:END:
******* TODO add the planets for Serpiens
:PROPERTIES:
:EFFORT:   5min
:END:
****** TODO flesh out the star systems mentioned in the EG [0/2]
...
:EFFORT:   5min
:END:
***** TODO Orion Federation [/]
****** TODO Enremdea[0/2]
:PROPERTIES:
:ORDERED:  t
:END:
******* TODO create templates for Enremdea
:PROPERTIES:
:EFFORT:   5min
:END:
******* TODO add the planets for Enremdea
:PROPERTIES:
:EFFORT:   5min
:END:
****** TODO flesh out the star systems mentioned in the EG [0/2]
